            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="leaveTable" role="grid" aria-describedby="leaveTable_info">
                            <table class="table my-0" id="leaveTable">
                                <thead>
                                <tr>
                                    <th>Leave ID</th>
                                    <th>Employee Name</th>
                                ...
                                <tbody>
                                <c:forEach var="leave" items="${allLeaveRequest}">
                                    <tr>
                                        <td>${leave.leaveId}</td>
                                        <td>${leave.empName}</td>
                                        ...
                                        <td>${leave.status}</td>
                                        <td>
                                            <a href="Leave-details?leaveId=${leave.leaveId}" class="btn btn-outline-warning">View</a>
                                            </a>
                                        </td>
                                    </tr>
                                </c:forEach>
