...
<div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">${emp.employeeName}'s Profile</h3>
                <div class="row mb-3">

                        <%--This is for the Photo & Project                    --%>
                    <div class="col-lg-3">
                        <div class="card mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="username"><strong>User Identity</strong></label>
                                                        <input
                                                            class="form-control" type="text" id="username"
                                                            placeholder="Id" name="username" disabled>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="email"><strong>Email Address</strong></label>
                                                        <input class="form-control" type="email" id="email" value="${emp.email}"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="${emp.employeeName}"
                                                               id="first_name" placeholder="John" name="first_name" disabled>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text"
                                                               id="last_name" placeholder="" name="last_name" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <button class="btn btn-outline-danger btn-sm" type="submit">Edit Request</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 fw-bold">Additional Details</p>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <div class="mb-3">
                                                ...
                                                <input
                                                    class="form-control" type="text" id="address" value="${emp.address}"
                                                    placeholder="Sunset Blvd, 38" name="address">
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="city"><strong>Role</strong></label>
                                                        <input
                                                            class="form-control" type="text" id="city" value="${emp.role.roleName}"
                                                            placeholder="" name="city">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="country"><strong>Department</strong></label>
                                                        <input
                                                            class="form-control" type="text" id="country" value="${emp.department.departmentName}"
